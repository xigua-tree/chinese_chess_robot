...
def debug_hough_center_ref(target_filename="5.jpg"):
    ...
    if not os.path.exists(target_path):
        target_path = os.path.join(current_dir, "五子棋引擎", target_filename)
    ...
    # 2. ROI 标定
    ROI_X, ROI_Y, ROI_W, ROI_H = 381, 4, 545, 678
    ...
    img_warped = cv2.warpPerspective(roi, M, (side, side))
